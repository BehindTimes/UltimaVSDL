...
const int RENDER_MULTIPLIER = 1;

const int RENDER_WIDTH = ORIGINAL_GAME_WIDTH * RENDER_MULTIPLIER;
const int RENDER_HEIGHT = ORIGINAL_GAME_HEIGHT * RENDER_MULTIPLIER;

const int LINE_THICKNESS = RENDER_MULTIPLIER;
...
const int RENDER_TILE_HEIGHT = 16 * RENDER_MULTIPLIER;
const int RENDER_TILE_WIDTH = 16 * RENDER_MULTIPLIER;
const int HALF_TILE_HEIGHT = 8 * RENDER_MULTIPLIER;
const int HALF_TILE_WIDTH = 8 * RENDER_MULTIPLIER;
...
const int IN_CHAINS = 356;
const int STOCKADE_TILE = 132;
const int CHAINS_TILE = 133;
