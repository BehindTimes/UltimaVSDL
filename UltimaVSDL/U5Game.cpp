...
void U5Game::Render()
{
	...
	m_sdl_helper->RenderTextureAt(m_sdl_helper->m_TargetTextures[TTV_MAIN_DISPLAY_BUFFER], -RENDER_TILE_WIDTH, -RENDER_TILE_HEIGHT, 13.0f * RENDER_TILE_WIDTH, 13.0f * RENDER_TILE_HEIGHT);
